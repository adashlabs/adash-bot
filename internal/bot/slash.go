...
func slashCommands() []*discordgo.ApplicationCommand {
	...
	return []*discordgo.ApplicationCommand{
		...
		permitted(command("yetkili", "Yetkili alım sistemini ve başvuru panelini yönetir.", subcommand("kanal", "Başvuru log kanalını ayarlar.", channelOption("kanal", "Log kanalı", true, discordgo.ChannelTypeGuildText)), subcommand("panel", "Başvuru panelini bu kanala gönderir."), subcommand("durum", "Yetkili alım durumunu ve ayarlarını gösterir.")), manageGuild),
		command("davet", "Kullanıcının sunucu davet istatistiklerini görüntüler.", userOption(false)), command("topdavet", "Sunucunun en çok davet yapan üyelerini listeler."),
